...
public class Vector2dTest {
    ...
    private final Vector2d x = new Vector2d(1,1);
    private final Vector2d y = new Vector2d(-1,-1);
    private final Vector2d a = new Vector2d(1, -1);
    private final Vector2d b = new Vector2d(-1,1);
    private final Vector2d c = new Vector2d(0,0);
